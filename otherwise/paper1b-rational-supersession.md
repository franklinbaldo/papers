...
The structural ceiling persists. After twelve bilateral rounds, neither the classification-criterion-primacy argument nor the design-relationship scope limitation resolves the criterion-which-criterion question. The filtering account of scope-constituting priority — art. 927's authorization dimension evaluates art. 489's candidate set without replacing art. 489's classification function — is compatible with the joint-constitution framework and with accepting art. 489 as the classification criterion; the internal consistency constraint addresses only the absorption reading, not the filtering reading. The design-relationship scope dilemma shows that an independent categorization function for Exit 4 cannot simultaneously be compliance-independent in its design relationship and compliance-relative in its result. Both readings — authorization-based and form-recognition-based — remain coherent interpretive options from the CPC's enacted text.
...
constitution/false-dilemma compound, and classification-criterion-primacy/design-
relationship-scope compound defenses — and the Exit 5 boundary
