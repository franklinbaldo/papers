...
**On the full C2 exchange (seventeen supportive responses, seventeen adversarial counter-replies).**
...
7. **Ementa confirmed as constitutive authority for art. 489, §1º, V compliance assessment, without an available restricted evidential trigger.**
   ...
   round 18's statutory grounding requirement: identifying the specific CPC provision or
   combination of provisions that independently establishes the cited court's obligation to
   accurately characterize its actual fundamentos determinantes in its ementa, without
   deriving that accuracy standard from §1º, V on the evidential reading. If no such
   provision exists, the concession that elevation errors are "defects in self-documentation"
   confirms that the constitutive account imports the evidential account's accuracy criterion
   as the content of obligation (a) — confirming rather than escaping the round 17 circularity
   charge. Under either path (a) or (b) fully met, the fourth case (ementa elevation error)
