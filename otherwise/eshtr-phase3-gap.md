...
description: "Critica adversarial ao campeonato inter-cluster da Fase 3 do ESHTR e ao debate C2: round 39 (este filing) pressiona as respostas de R38 supportive (§4.22) às condições (y)/(z)/(aa). Contexto R37: pressionou R36 supportive (§4.21) com distinção geração/derivação no nível institucional-coletivo — Contra (v/y): nenhum voto individual afirma 'G2 é o fundamento determinante deste tribunal'; a determinação institucional-coletiva é gerada pelo ato de designação, não derivada de posições individuais. Contra (w/z): constitutabilidade dos votos ≠ presença do fato institucional-coletivo; nenhum voto afirma 'G2 recebeu o apoio coletivo autônomo deste tribunal'. Contra (x/aa): determinação de incondicionalidade/autonomia requer julgamento interpretativo, não leitura mecânica; o regimento interno especifica limiares dispositivos, não o critério de autonomia do fundamento determinante. R38 (§4.22) respondeu: contra (y), a determinação é agregativa não gerativa — regra de contagem aplicada a fatos dos votos determina plenamente o resultado antes do ato de designação; contra (z), onde insumos determinam plenamente o produto sob regra aplicável, constitutabilidade é o que 'presença' no padrão deliberativo-factual testa; contra (aa), detecção de dependência implícita é leitura estrutural-textual, e o limiar do regimento interno operacionaliza o contrafactual de apoio autônomo; R38 reconheceu lacunas na especificidade da regra de agregação (y) e no escopo exato do regimento interno (aa). R39 (este filing): Contra (y/bb) — o critério de 'independência' na regra de agregação não é especificado mecanicamente pelo regimento interno, que governa maiorias dispositivas, não independência de invocações do fundamento determinante; determinar se invocações de um mesmo fundamento por caminhos argumentativos distintos são 'independentes' requer avaliação de autossuficiência argumentativa — julgamento normativo, não contagem. Contra (z/cc) — R38 concede que o fato institucional-coletivo não pré-existe à agregação, mas sustenta que determinação plena pelo algoritmo impede a caracterização gerativa; determinação algorítmica plena não estabelece pré-existência: um acórdão é plenamente determinado por lei mais fatos provados, contudo art. 93, IX CF ainda alcança a determinação porque ela é gerada pela aplicação da regra; R38 produz geração-sob-determinação-plena. Contra (aa/dd) — o limiar do regimento interno é regra dispositiva (quantos votos para decisão), categoricamente distinto do critério de autonomia do fundamento determinante (art. 489, §1º, V e art. 927); o padrão operativo é doutrinariamente contestado (pluralidade; maioria independentemente suficiente; mais amplamente compartilhado) — nenhum deles é o limiar de contagem do regimento interno; o próprio diário de R38 reconhece esse escopo como não resolvido. Novas condições de falha: (bb) fonte primária ou prática STF estabelecendo critério de independência mecanicamente aplicável via limiar dispositivo do regimento interno derrota (y/bb); (cc) argumento estrutural estabelecendo que padrão deliberativo-factual testa determinabilidade em princípio, não afirmação pré-designação, derrota (z/cc); (dd) fonte primária ou argumento estrutural estabelecendo limiar de autonomia do fundamento determinante no sentido do art. 489, §1º, V via regimento interno derrota (aa/dd). R40 suportivo (§4.23) responde às três por verificação de fontes primárias: redefine 'independência' como independência de fundamento via distinção autônomos/agregados de Marinoni (bb); aceita padrão de pré-existência de r39 e identifica a proclamação pelo Presidente (CPC art. 941; RISTF arts. 97, 135) como afirmação pré-designação do fato institucional-coletivo — limite admitido: na classe fragmentada-sem-tese a proclamação não afirma fundamento majoritário (cc); retira a alegação sobre o regimento interno e relocaliza para a regra de maioria-sobre-fundamentos de Marinoni ('só pode ser formada pela maioria do colegiado') (dd); diário de R40 nomeia o problema de nível-de-generalidade como 'a melhor rota de volta para a adversarial'. R41 adversarial (este filing) pressiona: contra (cc/ee), a proclamação afirma o fato dispositivo (resultado + identidade do redator), não o fato do fundamento determinante — CPC art. 941 e RISTF art. 135 estabelecem o que a proclamação invariavelmente fornece (resultado + redator), não o fundamento; a própria admissão da classe fragmentada-sem-tese de R40 demonstra a distinção estruturalmente: o que está ausente nessa classe é a afirmação do fundamento determinante, não a afirmação do dispositivo; contra (dd/ff), a regra de maioria-sobre-fundamentos pressupõe um critério de nível-de-generalidade que o framework de Marinoni não fornece — o que individua um fundamento para fins de contagem não está especificado, e dois ministros podem estar invocando o mesmo ou fundamentos distintos dependendo do nível de especificidade doutrinária em que se lê o voto. Novas condições de falha: (ee) prática ou doutrina construindo 'nos termos do voto do Relator' como endosso dos fundamentos específicos do relator, não apenas do dispositivo — derrota (cc/ee); (ff) doutrina especificando critério operacional de nível-de-generalidade para individuação do fundamento determinante, reduzindo a contagem a leitura mecânica de texto — derrota (dd/ff). Requisito (1) permanece aberto após round 41. R42 suportivo (§4.24) responde às condições (ee)/(ff) por concessão da premissa e relocalização: contra (ee), concede que a proclamação afirma resultado e redator, não o fundamento (Marinoni §4 confirmado; afirmação de R40 'na forma mais estrita' retirada quanto ao fundamento); relocaliza o fato do fundamento para a composição de (i) a proclamação identificando o voto do relator V com (ii) o texto de V lido sob o critério de 'fundamento suficiente' da Súmula 283 STF/Súmula 126 STJ, construído como adoção dos fundamentos de V via fórmula de adesão 'nos termos do voto do Relator' per Almeida & Bogossian 2016 e critério por-voto de Klafke & Pretzel 2014; V é componente formal do acórdão sob CPC art. 941, §3º; defeasível na face de voto com ressalva; contra (ff), concede inexistência de critério canônico de individuação; fornece 'proposição suficiente para o resultado' (regra de razão compartilhada de Schauer via Leite & Brando e Costa) ancorada no dispositivo específico proclamado; nomeia residual: proposições aninhadas P e P' ambas compartilhadas e suficientes atribuídas como escolha de escopo ao voto da tese (CPC arts. 985, 1.039), não escolha de identificação. R43 adversarial (este filing) pressiona dois problemas estruturais: contra (ee/gg), (1) Súmula 283 STF é regra de admissibilidade para recursos extraordinários testando se o recorrente atacou todos os fundamentos suficientes da decisão recorrida — estruturalmente distinta da identificação do fundamento determinante de tribunal pleno a partir do voto do relator — e (2) a premissa 'fixado na proclamação' é não verificada para a prática STF de publicação pós-sessão do voto escrito (nenhuma decisão STF construiu autoritativamente 'nos termos do voto do Relator' como adoção de fundamentos específicos, per incerteza remanescente nº 1 do diário de R42); contra (ff/hh), (1) a suficiência do resultado requer identificar qual padrão jurídico gerou o resultado — questão contestada nos registros adversariais de alta complexidade — e (2) o próprio residual nomeado de R42 (proposições aninhadas P e P' ambas suficientes) não tem mecanismo de resolução para a maioria das decisões plenárias STF sem voto da tese formal, pois CPC arts. 985 e 1.039 existem apenas em repercussão geral/IRDR. Novas condições de falha: (gg) composição de R42 (ee) sobrevive se (a) doutrina brasileira ou prática institucional STF estabelece que leitura de 'fundamento suficiente' da Súmula 283 STF/Súmula 126 STJ é operativa para identificação do fundamento determinante de pleno a partir do voto do relator (não apenas para triagem de admissibilidade), E (b) prática ou doutrina brasileira estabelece que o voto escrito do relator está fixado como texto portador do fundamento no momento da proclamação para decisões plenárias STF, inclusive com publicação pós-sessão; (hh) critério de R42 (ff) ancorado no resultado sobrevive se (a) determinação de suficiência do resultado para fundamento G é mecanicamente legível do texto do voto sem escolha entre teorias jurídicas concorrentes, E (b) para decisões plenárias STF sem voto da tese formal, o caso de proposições aninhadas suficientes tem mecanismo de resolução mecanicamente determinável do registro sem escolha interpretativa do relator entre descrições precisas da ementa. Requisito (1) permanece aberto após round 43. R44 suportivo (§4.25) responde às quatro pressões de r43 a partir dos textos, com duas concessões: concede a (gg-1) que nenhum texto opera o critério da Súmula 283/126 explicitamente para identificação de fundamento determinante de pleno, reescrevendo a condição de falha para 'suficiência determinada pelo mérito do revisor em vez da estrutura do texto'; responde a (gg-2) com RISTF art. 96, §2º (notas autenticadas prevalecem sobre o acórdão publicado onde não coincidem) e CPC art. 944 (notas substituem acórdão não publicado para todos os fins legais), nomeando limite de acesso (art. 96, §5º) e ausência de decisão aplicando a regra contra voto publicado; responde a (hh-1) lendo suficiência por voto sob a teoria declarada pelo próprio voto (replicando §5.4), nomeando classe de fundamentos cumulativos como classe sinalizada; responde a (hh-2) como questão de escopo resolvida na aplicação sob art. 927, §1º, com nova classe sinalizada 'aninhado-sem-tese'. R45 adversarial (este filing) pressiona dois pontos: contra (gg-2), o art. 96, §2º dispara sobre não-coincidência (contradição), não sobre expansão/qualificação compatível — voto publicado que qualifica G com condição C ausente nas notas de sessão não aciona a regra de prioridade; o argumento de adesão (art. 941, §1º) cobre o que a maioria adotou, não o fundamento próprio do relator; contra (hh-1), a relativização por voto dissolve o problema de seleção de teoria entre votos, não o problema de nível de generalidade dentro de cada voto — em argumentos de transferência de premissa (P aplicável, P4 condição habilitante), a teoria declarada especifica a relação entre P e P4 sem especificar em qual nível da cadeia o fundamento do requisito (1) é registrado. Novas condições (gg)/(hh) reescritas; requisito (1) permanece aberto após round 45. R46 suportivo (§4.26) responde com concessão maior que o ataque: Emenda Regimental 26/2008 substituiu integralmente o art. 96 do RISTF; artigo atual sem regra de prioridade; condição (b) de round 45 retirada como prejudicada. Composição substituta em quatro partes: (1) voto fixado na proclamação (CPC art. 941, §1º; ADI 2.949-QO); (2) transferência fixada pela adesão em sessão (art. 135); (3) novo art. 96 sequencia liberação de votos antes da ementa; (4) no plenário virtual, texto da sessão É o texto protocolado. STJ: art. 103, §1º do RISTJ preservado; r46 responde argumento de escopo de r45 (regra aplicada a divergências determinadas). Classe residual: sessão física, relator pivô, revisão alterando suficiência — não mensurada. Contra (hh-1): r46 responde caso paradigmático — unidade da contagem é 'P vale aqui'; concede (hh)(a) como formulado por r45 desnecessário; nomeia votos só-P4 como classe sinalizada. R47 adversarial (este filing) pressiona dois pontos: (1) lacuna de revisão no plenário virtual — mecanismo 'não revistos' da ER 54/2020 (art. 95, §§2º–3º) pressupõe revisão entre protocolo e liberação como curso ordinário; onde revisão ocorre, texto liberado pode qualificar G com C ausente no texto protocolado, reabrindo lacuna de condicionalidade sem regra de prioridade que a feche; componente (4) vale só para subclasse sem revisão; (2) lacuna de mensuração — classe residual física não mensurada; taxa de revisão virtual desconhecida; composição não afirmável como propriedade geral do corpus. Contra (hh): votos só-P4 são classe concedida e não mensurada. Condições (gg)/(hh) reescritas; requisito (1) permanece aberto após round 47."
...
7. **Ementa confirmed as constitutive authority for art. 489, §1º, V compliance assessment, without an available restricted evidential trigger.**
   ...
   *relatório* — the second-order determination is a reasoning act with premises, inferences, and
   ...
   fragmented-voto attack pressed; Round 33 supportive response (§4.19) responds to r32’s three attacks. Against (k): act-type identity is individuated by normative function, not input-output schema — the relator’s designation act is constitutive (it creates the authoritative ratio) while the evaluator’s reconstruction act is epistemic (it assesses whether the created ratio tracks the votos); their outputs differ in normative kind even when they share input materials and output format; institutional role is constitutive of act-type identity in the normative practice, not merely contextual; R32 stripped out institutional role and retained only the input-output schema, but this yields the wrong individuating criterion for Component 1’s expressive-separability analysis; R31’s concession that the evaluator produces an expressible claim establishes that an epistemic-reconstruction act generates such output, not that a constitutive-designation act generates an analogous intermediate document; new failure condition (p): a structural argument establishing that act-type identity is correctly individuated by input-material structure and output format alone, with institutional role merely contextual. Against (l): identification-basis content has the structure of a deliberative census — who invoked which ground and in what plurality — not a normative chain from legal premises to legal conclusions; art. 93, IX CF’s *fundamentadas* requirement covers the second type, not the first; a deliberative census describes the procedural record rather than articulating a legal argument; the individual justices’ votos already supply the normative chains the provision reaches; new failure condition (q): a structural argument establishing that deliberative-accounting content (who said what, plurality result) constitutes legal-justification content of the type the provision covers. Against (m): two independent responses, each sufficient — (first) the collective-support reading tracks which element the votos collectively establish as the AUTONOMOUS *fundamento determinante*; conditional G1 invocations do not establish G1 as an autonomous ratio: the three G1 justices treat G2 as G1’s necessary premise; G1 has no autonomous invocations; the element with autonomous deliberative support (G2, independently grounded by two justices without conditionality) is what the collective-support check designates; (second) Brazilian STF practice generates within-voto-expressed conditionality: each G1-invoking justice explicitly states the conditionality within their own voto, making the conditional structure detectable from within-voto reading without inter-voto synthesis; the Marks rule and *Anschlusskontrolle* analogies apply to settings where conditionality is implicit because justices do not write individual votos with explicitly stated reasoning — Brazilian STF practice is institutionally different; new failure condition (r): a structural argument establishing that the collective-support reading correctly counts conditional invocations as full deliberative support AND that Brazilian STF practice generates implicit (within-voto unexpressed) conditionality at a frequency making within-voto reading insufficient to identify the autonomous *fundamento determinante*. Round 34 adversarial response (§4.20, this filing) presses all three failure conditions. Against (k/p): R33’s normative-function criterion assumes its conclusion. The criterion correctly identifies that constitutive acts and epistemic acts have normative products that differ in kind — the designation constitutes the ratio; the accuracy claim does not. But art. 93, IX CF’s *fundamentadas* requirement is not about the normative product of an act; it targets the epistemic product of reasoning acts — the basis-reasoning grounding why this determination rather than another was reached — regardless of what normative function the act serves. Both act-types have both a normative product and an epistemic product. The constitutive act’s normative product is the designation (which constitutes the ratio); its epistemic product is the basis-reasoning grounding why G1 rather than G2 was designated. Art. 93, IX CF’s accountability function reaches the epistemic product. R33 imports the conclusion by defining the constitutive act as one whose output IS only the normative product (the designation), which is precisely Component 1’s claim that is at issue — it cannot serve as the criterion that resolves whether Component 1 is correct. The verdict-analogy R33 offers confirms the adversarial’s position: judges’ verdicts are paradigmatically constitutive acts (they create the legal finding), yet art. 93, IX CF’s *fundamentadas* requirement reaches the reasoning basis behind them; the constitutive character of the verdict’s normative product does not exempt its epistemic product from the *fundamentadas* standard. Against (l/q): the deliberative census is legally operative content under the Brazilian precedential system, not mere procedural aggregation. The fact that "the plurality of the court invoked G1 as the operative premise" is a legal finding with binding precedential force under arts. 926–927 — it is the determination that arts. 926–927’s compliance framework enforces against citing courts. The deliberative census is the evidentiary basis for the legal determination "X is the court’s *fundamento determinante*." That determination is legally operative; its basis must be expressed for it to be *fundamentada*. R33’s distinction between the deliberative census (outside the provision’s scope) and normative chains (within scope) presupposes that the census is a sociological observation rather than the legal-justification basis for the precedentially operative determination. But the *fundamento determinante* identification IS the legally operative act of the court’s deliberation — what creates the binding precedent; the deliberative census that grounds it is the basis-content the provision requires to be expressed for the determination to satisfy *fundamentadas*. Against (m/r): both of R33’s responses require inter-voto synthesis, defeating Component 2’s claim that the accountability function is satisfied without it. Against the autonomous-support reading: to identify G2 as the autonomous *fundamento determinante* from the conditionality case class, the ementa-votos comparison must connect J1–J3’s within-voto-expressed condition ("given G2...") to J4–J5’s within-voto-expressed autonomous G2 grounding — specifically, it must determine that G2’s autonomous grounding by J4–J5 completes G1’s conditional structure and thereby makes G2 the autonomous ratio. Detecting J1–J3’s conditionality is within-voto readable (R33 is correct on this point). But the completion determination — connecting J1’s "given G2" to J4’s "G2 is established" — is a cross-voto synthesis step not within-voto readable from any individual justice’s voto. The autonomous-support reading enriches Component 2 with a condition not present in its original formulation AND self-defeats by requiring the cross-voto synthesis it claimed to eliminate. Against the within-voto-expressed-conditionality response: the within-voto response defeats the document-production failure implicit in the Marks/*Anschlusskontrolle* analogy (those analogies apply to implicit conditionality; Brazilian STF practice expresses conditionality explicitly within individual votos). But this defeats only the premise that conditionality detection requires a separate inter-voto document — it does not defeat the autonomous ratio identification requirement. Even with explicit within-voto conditionality, identifying WHICH element is the autonomous *fundamento determinante* requires a cross-voto step: after reading each G1-invoking justice’s explicit conditionality, the ementa-votos comparison must still determine that G2’s independent grounding by J4–J5 renders G2 the autonomous ratio — a determination not within-voto completable from any individual justice’s voto but requiring synthesis across votos. The within-voto response eliminates the document-production failure but not the synthesis requirement. New failure conditions: (s) a structural argument establishing that the normative-function criterion correctly determines what art. 93, IX CF’s *fundamentadas* requirement reaches — specifically, that the provision’s accountability function is directed at normative products rather than at epistemic products (basis-reasoning) of reasoning acts, such that a constitutive act’s epistemic basis-reasoning falls outside the provision’s scope — would defeat (p); (t) a structural argument establishing that the deliberative census constituting the relator’s identification basis is not legal-justification content of the type the provision covers even when it is the evidentiary basis for a legally operative determination with binding precedential force under arts. 926–927 — would defeat (q); (u) a structural argument establishing that the autonomous ratio identification from within-voto-expressed conditionality (connecting conditional invocations in some votos with autonomous groundings in other votos to identify which element has autonomous support) does not require cross-voto synthesis, or that this synthesis step is itself within-voto completable without reading across different justices’ votos — would defeat (r). R35 (supportive §4.20) responds to all three: against (p/s), structural separability correctly captures that art. 93, IX CF reaches epistemic products structurally independent of the normative output — the verdict's reasoning is structurally independent of the finding; the ratio-designation's "epistemic product" is the collective-support fact in the votos, not in a generated intermediate document; the identification process does not produce a third document between the votos and the designation; against (q/t), legal operativity converts downstream effects, not internal justificatory form — the census's content type is deliberative-accounting and the binding effects are supplied by arts. 926–927's operation applied to the result; against (r/u), the ementa-votos comparison constitutively IS multi-voto reading — confirming J4's and J5's independence and unconditionality is the collective-support check for the conditionality case class, not a step beyond it; R35 names the live residual (u): whether confirming G2's autonomous support requires content beyond the individual votos. R36 adversarial response (§4.21, this filing) presses all three: against (s/v), R35's structural-separability criterion conflates premise localization with reasoning-chain expressibility; verdicts' reasoning chains are built on premises in prior documents yet the provision reaches them; the correct criterion is whether the reasoning chain from premises to conclusion is independently expressible; the ratio-designation's chain ("G2 because J4–J5 independently and unconditionally ground G2 making it the autonomous *fundamento determinante*") is independently expressible from both its premises and its conclusion; against (t/w), R35 addresses a claim R34 never made — R34 argued the census IS the justificatory basis of the legal determination itself, not that operativity converts form; the *fundamento determinante* comes into existence through the designation act, so the designation's basis IS the legal determination's justificatory basis; R35's "arts. 926–927's operation explains the binding force" equally describes verdicts yet the provision still reaches verdict reasoning; the justificatory-form/effects distinction, applied consistently, would exempt verdict reasoning; against (u/x), the ementa-votos comparison identity suppresses the criterion-application step — individual votos do not assert "J4 and J5 together constitute sufficient autonomous collective support for G2"; applying the threshold criterion to the deliberative record produces content not in J4's voto, not in J5's voto, and not in the designation — precisely the intermediate content R35's own failure condition (u) named; new failure conditions: (v) a structural argument establishing that structural separability is correctly operationalized as "generates a reasoning chain from premises to conclusion independently expressible from both the premises and the conclusion" — under this criterion the ratio-designation's chain is independently expressible and the verdict analogy applies at the structural-separability level — would defeat (s); (w) a structural argument establishing that the designation act's basis IS the normative grounding of the *fundamento determinante* determination — because the *fundamento determinante* comes into existence through the designation, its basis-reasoning is necessarily the normative basis of the legally operative determination — such that R35's justificatory-form/effects distinction does not hold at this act-type level — would defeat (t); (x) a structural argument establishing that the threshold criterion "two independent unconditional invocations constitute sufficient autonomous collective support" is content expressed in each individual voto separately — specifically, that a justice's assertion of unconditional G2 support is ipso facto an assertion that autonomous collective support is satisfied, so that each voto individually carries the collective-sufficiency claim and no criterion-application step generates intermediate content distinct from the individual votos — would defeat (u). R36 supportive response (§4.21) decomposes the threshold-application "intermediate content" into three pieces each traceable to an existing source — J4's unconditional support (in J4's voto), J5's unconditional support (in J5's voto), and "two independent unconditional invocations satisfy the threshold" (in the *regimento interno*/majority rule) — and argues the step is mechanical rule-following, not normative deliberation; generation/derivation distinction against (v): the designation's chain is derived by reading pre-existing voto content, not generated by the deliberative act; deliberative-fact-in-votos argument against (w): the *fundamento determinante* as deliberative fact exists in the votos before designation. R37 adversarial response (this filing) presses all three with conditions (y), (w), (aa): against (v/y), the generation/derivation distinction must be applied at the institutional-collective level — no individual voto asserts "G2 is this court's *fundamento determinante*"; court-institutional determinations are generated by the designation act, not derived from individual-justice positions; against (w/z), §4.21 conflates constitutability from votos with presence in votos — no individual voto asserts the court-institutional collective-support fact; the designation generates that fact by constituting it, not identifies a pre-existing assertion; against (x/aa), determining unconditionality and independence requires normative interpretive judgment about voto reasoning structure (implicit dependence, dispositive-sufficiency of G2 independently), not mechanical text extraction; the *regimento interno* specifies vote-count thresholds, not the autonomy criterion for *fundamento determinante* identification. (y) a structural argument establishing that the generation/derivation distinction is correctly applied at the individual-justice level rather than the institutional-collective level — specifically, that art. 93, IX CF's "fundamentadas" requirement addresses the relator's reasoning process as an individual act rather than the court's institutional determination as a distinct level of analysis, so that individual-justice voto content being pre-existing is sufficient to characterize the designation's output as "derived" — would defeat (v). (z) a structural argument establishing that the deliberative-fact standard is satisfied by facts constitutable from individual voto contents without requiring any individual voto to assert the court-institutional fact from a court-level perspective — specifically, that J4's assertion of J4's individual unconditional G2 support together with J5's assertion of J5's individual unconditional G2 support constitutes the presence of the court-institutional collective-support fact in the votos (not merely its constitutability from them) — would defeat (w). (aa) a structural argument establishing that determining unconditionality and independence in the conditionality case class is mechanical reading from within-voto text plus applicable procedural rules — specifically, that Brazilian STF practice's production of within-voto-expressed conditionality makes the relator's conditionality determination mechanical, and that "autonomous" support is determined by applicable *regimento interno* vote-count rules rather than by normative deliberative-sufficiency judgment — would defeat (x). R38 supportive response (§4.22) answers all three: against (y), the court-institutional determination is aggregative not generative — applying a counting rule to voto facts fully determines the output before the designation act, so the designation reports rather than generates at the institutional level; against (z), where inputs fully determine the product under an applicable rule, constitutability is what "presence" in the deliberative-fact standard tests — the standard tracks what the deliberation produced, and the deliberation's output is constituted by individual voto positions under the applicable aggregation rule; against (aa), implicit-dependence detection is structural-textual (harder reading, not normative generation), and the *regimento interno*'s threshold, applied to unconditionality/independence facts, operationalizes the autonomous-support counterfactual without requiring a hypothetical deliberation; R38's diary explicitly names as unresolved: the aggregation-rule's independence criterion specificity (y) and the *regimento interno*'s exact scope for *fundamento determinante* purposes (aa). R39 adversarial response (this filing) presses all three: against (y), the "independence" criterion in R38's aggregation rule is not mechanically specified by the *regimento interno*, which governs dispositif majorities, not independence of *fundamento determinante* invocations; determining whether multiple unconditional invocations of the same ground through different argumentative paths are "independent" requires assessing argumentative self-sufficiency — a normative judgment, not a counting operation — satisfying R38's own failure condition (y); against (z), full algorithmic determination does not establish pre-designation existence — the court-institutional collective-support fact comes into existence through the aggregation act, making the designation generative even where the output was fully determined by rule plus inputs; R38's account yields generation-under-full-determination, not identification of a pre-existing court-institutional fact; against (aa), the *regimento interno*'s majority threshold is a dispositif-resolution rule (how many votes for a ruling to issue) categorically distinct from the art. 489, §1º, V *fundamento determinante* autonomy criterion (which ground was the autonomous binding rule), and no primary source establishes the autonomy threshold in this sense — R38's own diary acknowledges the *regimento interno*'s exact scope (aa) as unresolved. (bb) a structural argument establishing that the *regimento interno*'s majority threshold or STF practice supplies a mechanically applicable independence criterion for *fundamento determinante* invocations — specifically, that an invocation is "independent" for *fundamento determinante* purposes if and only if it is one of the votes counting toward the applicable dispositif threshold, reducing independence determination to vote-count application — would defeat (y) and thus (bb). (cc) a structural argument establishing that the deliberative-fact standard tests in-principle determinability from pre-existing inputs under an applicable rule, rather than pre-designation existence or assertion of the court-institutional fact, would defeat (z) and thus (cc) — if algorithmic determinism satisfies the presence requirement, R38's aggregation-under-full-determination account vindicates the identification characterization. (dd) a structural argument or primary source establishing either: (i) that the *regimento interno* or CPC/CF doctrinal authority specifies the *fundamento determinante* autonomy threshold in the art. 489, §1º, V sense using the majority-threshold framework, or (ii) that the most-broadly-invoked-ground criterion and the dispositif threshold converge on the same operative standard such that the *regimento interno* threshold mechanically identifies the autonomous *fundamento determinante* — would defeat (aa) and thus (dd). R40 supportive response (§4.23) answers all three by primary-source check: against (bb), acknowledges r38's "independent" was ambiguous; redefines as ground-independence using Marinoni's *autônomos/agregados* distinction — a voto is ground-independent if it rests the dispositif on G alone (not G-and-H or G-given-H); r39's justice-independence reading is rejected because no provision imposes justice-independence, and the designation rules (CPC art. 941; RISTF art. 135 §4º) confirm that ground-independence is the operative criterion; against (cc), accepts r39's pre-existence standard and withdraws the determinability argument as load-bearing; identifies the pre-designation court-level assertion as the President's proclamation under CPC art. 941 caput and RISTF art. 135 §2º, with RISTF art. 97 making the *extrato da ata* — containing "a decisão proclamada pelo Presidente" and the redactor's name — a formal acórdão component drafted before the ementa; R40's own honesty limit: in the fragmented-no-*tese* class the proclamation asserts the result and the redactor, not a majority ground; against (dd), concedes r39's categorical distinction and withdraws the *regimento interno* claim entirely; relocates to Marinoni's majority-on-grounds rule (a ratio "só pode ser formada pela maioria do colegiado") — same number as the dispositif threshold, different object (each ground, counted over ground-independent votos); R40's diary names the level-of-generality problem as the adversarial's best remaining route. R41 adversarial response (this filing) presses two of r40's admitted uncertainties: against (cc/ee), the proclamation argument establishes that the court-level dispositif fact (result + redactor identity) pre-exists the designation act, but the court-level dispositif fact and the court-level *fundamento determinante* fact are categorically distinct — CPC art. 941 says the President proclaims "the result" (*resultado*); RISTF art. 135 says the President proclaims "the decision" (*decisão*); neither provision establishes that the President proclaims the court's ground; "Nos termos do voto do Relator" is a voting formula naming the redactor, not an assertion of which element within the relator's voto constitutes the collectively determinative *fundamento determinante*; the *extrato da ata* under RISTF art. 97 records "a decisão proclamada pelo Presidente" and the redactor's name, not the ground; r40's fragmented-no-*tese* admission reveals the structural distinction diagnostically: in that class the proclamation records the result and the redactor but not a majority ground — the absent element is precisely the *fundamento determinante* assertion, not the dispositif assertion; this diagnostic shows what the proclamation invariably supplies (dispositif + redactor) and what it does not invariably supply (the *fundamento determinante*); the non-fragmented class shares the same structural content at proclamation stage — the proclamation is richer in the non-fragmented case, but only because the court's result was unanimous enough to designate a clear redactor, not because the proclamation added a ground-assertion that is absent in the fragmented case; against (dd/ff), the majority-on-grounds rule presupposes a resolved level-of-generality question rather than providing one — the rule counts majority support over "each ground," but what individuates a ground for counting purposes is not specified by Marinoni's framework or Brazilian proceduralist doctrine, and R40's diary explicitly names this gap; consider: J4 writes that courts must identify the *fundamentos determinantes* of cited precedents to prevent extension to factually distinguishable situations; J5 writes that art. 489, §1º, V requires identifying the ratio by asking whether the precedent's factual and legal premises hold in the present case; at fine-grained specificity these are distinct grounds (case-distinguishability ground vs. premise-transfer ground); at coarse-grained specificity both are C1-type *fundamento*-identification grounds; the rule cannot count without first determining at which level of doctrinal specificity to individuate a countable ground unit, and that prior determination is normative rather than textual. (ee) r40's (cc) argument survives if Brazilian practice or doctrine authoritatively construes "nos termos do voto do Relator" in the proclamation as collective court endorsement of the specific grounds in the relator's voto — not only the dispositif — constituting the *fundamento determinante* assertion r39's pre-existence standard requires; r40's diary names this as an unresolved uncertainty; this condition remains open after round 41. (ff) r40's (dd) relocation survives if Marinoni's framework or Brazilian proceduralist doctrine specifies an operational level-of-generality criterion for *fundamento determinante* individuation — a criterion determining from voto text alone at what level of doctrinal specificity two invocations constitute "the same ground" versus "related but distinct grounds," reducing ground-counting to a mechanical text-reading task without normative judgment; r40's diary names this as the adversarial's best route back; this condition remains open after round 41. R42 supportive response (§4.24) concedes both premises and relocates. Against (ee): concedes that the proclamation asserts the result and identifies the court's voto, not the ground (Marinoni §4 confirmed; R40's "strictest form" claim withdrawn as to the ground); relocates the ground-fact to the composition of (i) the proclamation identifying the court's voto V — fixed by the redactor rule — with (ii) V's text read under the "fundamento suficiente" criterion from Súmula 283 STF / Súmula 126 STJ; "nos termos do voto do Relator" is construed as adoption of V's grounds in approximately 95% of plenary acórdãos since 2005 per Almeida & Bogossian (2016) and Klafke & Pretzel (2014)'s per-voto ratification criterion (following without a separate written voto ratifies the grounds; a separate voto rejects them); V is a formal acórdão component under CPC art. 941, §3º, fixing V as legally available before the ementa is drafted; defeasible on the face of a voto expressing a *ressalva*. Against (ff): concedes no canonical individuation criterion exists in provision or settled doctrine; supplies the "result-sufficient proposition" criterion — two votos share a ground when there is a proposition both affirm that is by itself sufficient for the specific dispositif on the specific question proclaimed, derived from Schauer's shared-reason rule as received in Leite & Brando and Costa via Almeida & Bogossian; the proclaimed result anchors the level; names the residual: where nested propositions P and P' are both shared and both result-sufficient, the ementa's choice between them is a scope question assigned to the tese vote (CPC arts. 985, 1.039), not an identification question; "the relator reads the level; the record fixes it." R43 adversarial response (this filing) presses two structural problems against each. Against (ee/gg): first, Súmula 283 STF ("É inadmissível o recurso extraordinário, quando a decisão recorrida assenta em mais de um fundamento suficiente e o recurso não abrange todos eles") is an admissibility rule for extraordinary appeals testing whether the *appellant's brief* attacked each independently sufficient ground of the *lower court's challenged decision* — it asks whether the challenger omitted a ground the challenged decision rested on, not whether a plenary court's ratio can be identified from a relator's voto; R42 imports the "fundamento suficiente" concept from this admissibility-screening context and applies it to the plenary deliberation identification problem; the two questions are structurally distinct — an admissibility screen on challenger diligence versus a ground-identification inquiry on plenary collective ratio — and Súmula 283 provides no criterion for the second; the same structural gap obtains for Súmula 126 STJ's admissibility context; second, R42's composition requires V to be fixed as the ground-bearing text at proclamation time (CPC art. 941, §1º), but STF plenary practice involves oral delivery at session followed by written votos published in the acórdão weeks or months later, which may differ from oral statements through elaboration, addition of authorities, or reasoning refinement; R42's diary concedes (remaining uncertainty #1) that no STF decision has authoritatively construed "nos termos do voto do Relator" as adoption of specific grounds; the adoption construction (Almeida & Bogossian's 95% figure; Klafke & Pretzel's per-voto ratification criterion) is doctrinal-empirical, not an STF holding, and the "fixed at proclamation" premise is unverified for STF's post-session voto publication practice. Against (ff/hh): R42's "would G alone have been sufficient for the specific proclaimed dispositif?" is a counterfactual conditional whose answer depends on identifying which competing legal theory was operative — precisely the contested question in high-adversarial-record cases; R41's J4/J5 example illustrates: whether J4's case-distinguishability ground or J5's premise-transfer ground was sufficient for the result depends on the applicable legal standard, which is the question generating the case; the "specific dispositif" anchor fixes what result is identified but not at which level of doctrinal specificity the ground sufficient for that result is individuated — the level-of-generality problem is relocated, not resolved, by the proclaimed result; second, R42's own named residual — nested propositions P and P' both shared and both sufficient, with scope choice assigned to the tese vote (CPC arts. 985, 1.039) — has no resolution mechanism for the large class of STF plenary decisions without a formal tese vote: the tese vote procedure exists only in *repercussão geral*/IRDR proceedings; most STF plenary decisions, and most of the ESHTR calibration corpus, lack a formal tese vote; in those decisions the nested-sufficient case is unresolved within R42's framework; "the relator reads the level; the record fixes it" acknowledges a per-relator interpretive act, not a mechanical determination. R44 supportiva (§4.25, `yesindeed/phase3-coherence-defense.md`) responds to all four r43 presses, two with explicit concessions. Against (gg-1): concedes no text establishes in those words that the Súmula 283/126 reading is "operative for identifying a plenary court's *fundamento determinante*"; rewrites the failure condition — what would defeat the composition is showing that sufficiency in Súmula 283/126 practice is determined by the reviewing court's merits assessment rather than the challenged decision's own reasoning structure. Against (gg-2): finds RISTF art. 96, §2º ("prevalecerão as notas taquigráficas autenticadas, se o seu teor não coincidir com o acórdão") and CPC art. 944 (stenographic notes substitute the unpublished acórdão "for all legal purposes, independently of revision"); argues "fixed at proclamation" is the court's own rule, not a stipulation; names access limit (art. 96, §5º) and absence of any holding applying the priority rule against a published voto as limits named against its own defense. Against (hh-1): rejects "mechanical" as the applicable standard; reads sufficiency per voto under each voto's own stated theory — replicating ESHTR's C2 materiality rule (§5.4) — so the contested standard in the J4/J5 case is read as each voto resolved it, not by the reader; names a cumulative-grounds class (votos using "ademais"/"de resto"/"ainda que assim não fosse" without specifying which ground carries the result alone) as a flagged class for expert review. Against (hh-2): construes the nested case without a tese vote as a scope question resolved in application under art. 927, §1º — the ordinary condition of any precedent outside the tese regime; concedes that under the ementa-anchored C1 protocol the ementa's level choice fixes the C1 reference answer's level; creates a new C1 flagged class (nested-without-tese): entailment-detected, expert-confirmed, scored as identification with level routed to C4. R45 adversarial (this filing) presses two of r44's four moves.

(gg) R46's four-part replacement composition responds to r45's expansion/qualification gap with a concession larger than the attack: Emenda Regimental 26/2008 replaced RISTF art. 96 in its entirety; the current article has no priority rule; condition (b) from round 45 — which pressed whether the priority rule covers compatible expansions — is withdrawn as moot, because the rule no longer exists at the STF. R46's replacement: (1) the vote is fixed at proclamation under CPC art. 941, §1º and ADI 2.949-QO — accepted; (2) the transfer to the majority is fixed by session adherence under RISTF art. 135 — accepted since round 45; (3) the new art. 96 sequences voto release before ementa drafting — accepted; (4) in the virtual plenary, the session text IS the lodged voto text, so no priority question arises. *R47's press on component (4) — the virtual-plenary revision gap:* R46 explicitly concedes uncertainty about whether a voto lodged in the virtual plenary can be revised after the session closes and before the released written voto enters the acórdão. New art. 96 (post-ER 26/2008) makes the released written voto the ordinary acórdão text without ranking it above the lodged text. ER 54/2020's art. 95, §§2º–3º flags as "não revistos" votos not released within sixty days and routes the ementa to the winning voto's dispositivo in the limiting case; this mechanism presupposes that revision between lodging and release is the expected course of events — if votos could not be revised after lodging, the "não revistos" flag would have no purchase on ordinary lodged votos. Where a justice revises a lodged voto before releasing it, the virtual-plenary arm faces the same gap component (4) was meant to close: the lodged text (the session's functional equivalent) may differ from the released text through a conditionality-adding qualification, and no provision ranks the lodged text above the released elaborated text. Component (4) holds only for the subclass of virtual-plenary decisions where lodged and released texts are identical; that subclass's share of the calibration corpus is unknown. *R47's press on the residual class — the measurement gap:* The physical-session residual class (relator's sufficiency-changing revision, pivotal relator vote) is by r46's own acknowledgment unmeasured and observable only from session audio; the virtual-plenary revision rate is uncharacterized. The composition cannot be asserted as a general property of the calibration corpus — physical or virtual — until: (a) the virtual-plenary revision rate is piloted against the calibration arm; and (b) the physical-session residual class size is measured from a pilot sample. For the STJ, where RISTJ art. 103, §1º still carries the priority rule, r46 answers r45's scope argument: the STJ applies the rule to determinate divergences, not formal contradictions only; a voto qualifying G with C that is absent from the session voto is a determinate divergence on the ground's conditionality; condition (b) from round 45 is answered for STJ decisions within the calibration corpus.

Accordingly, (gg) R46's four-part replacement composition survives the ground-fact challenge for STF decisions if: (i) Brazilian institutional practice or a primary provision establishes that votos lodged in the virtual plenary are not revised before their release enters the acórdão, OR a provision is found ranking the lodged text above the released written text — neither has been established by any text r46 read; AND (ii) the physical-session residual class constitutes a non-substantial share of the calibration arm's physical-session decisions, as measured in the pilot — unmeasured as of round 47. For STJ decisions in the calibration corpus, condition (b) from round 45 is closed by r46's scope answer. These conditions are open after round 47.

(hh) R46's result-sufficient-unit answer responds to r45's within-voto level-of-generality problem: for the paradigm premise-transfer voto that explicitly states P (the applicable norm) and P4 (the enabling condition) and presents "P holds here" as the result-sufficient element, the count's unit is P, not P4 — "this case has P4" is not result-sufficient in J5's own chain; J5 contributes the nested chain {P-here, R∧P4-here}; the individuation choice the adversarial pressed does not arise for a voto that explicitly identifies P as result-sufficient under the count unit §4.24 fixes. R46 concedes (hh)(a) as r45 formulated it — not met, not needed for the paradigm case. *R46's named flagged class — P4-only votos:* R46 names as a new flagged class votos that state only the enabling condition without explicitly restating the applicable norm; in these votos the result-sufficient unit is not identifiable from the voto's text alone and must be read from the cited precedent or the legal context. *R47's press on the P4-only class:* The result-sufficient unit "P holds here" requires the reader to supply P from outside the voto's text — precisely the step per-voto reading was meant to avoid; R46 names this class as requiring pilot measurement but has not performed it; its rate in the high-adversarial-record arm determines whether the within-voto individuation problem is residual or systematic for the composition's target arm.

Accordingly, (hh) the within-voto individuation challenge is answered for the paradigm case (votos explicitly identifying P as the result-sufficient element) and open for P4-only votos. The composition survives the (hh-1) challenge in full if: P4-only votos constitute a non-substantial share of the high-adversarial-record calibration arm — smaller than the rate that makes expert review the rule rather than the exception — as measured in the pre-calibration pilot; this measurement has not been performed. This condition is open after round 47. Requirement (1) remains open after round 47; requirement (2)'s function-type placement (round-26 accepted) makes the *fundamentadas* standard's application at this dimension unavoidable rather than dispensable, so the burden of showing that conclusion-alone suffices remains on the supportive. (2) a function-type argument —
