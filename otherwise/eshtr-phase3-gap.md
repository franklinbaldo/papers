...
**Fifteenth adversarial response — round 16: V/VI textual-economy argument conceded — V's *identificar* is purely designative; ementa-anchored *seus* conceded — the ementa constitutes the objective reference set; third case from round 15 conceded as handled by ementa-anchored reading; constitutive authority of the ementa contested — a fourth case the purely designative ementa-anchored reading cannot handle without either presupposing constitutive authority or reinstating conceptual-coverage content.**

The supportive round 15 advances three responses: (1) *seus* — the ementa constitutes the objective reference set that "seus fundamentos determinantes" denotes; the designative check is ementa-level text-to-text comparison; (2) V/VI textual economy — the absence of *que justifiquem* from V is intentional; if V already carried application-justification content, VI's *que justifiquem* would be redundant; non-redundancy requires V's *identificar* to operate without that requirement — purely designative; (3) third case — caught by the ementa-anchored reading; a court that nominates a proposition the ementa does not characterize as fundamento determinante fails C1. Four positions follow.

*V/VI textual-economy argument: conceded.* The supportive's inversion of the adversarial's own round 15 non-redundancy concession is accepted. Round 15 accepted that V and VI are non-redundant failure conditions. If VI's *que justifiquem* clause adds application-justification content that V does not supply, then V's *identificar* operates without that requirement — purely designative. The inversion is sound: the adversarial cannot simultaneously accept V/VI non-redundancy and maintain that V's *identificar* carries the same application-justification content *que justifiquem* supplies in VI. The purely designative reading of *identificar* is accepted on structural grounds derived from the V/VI textual-economy argument.

*Ementa-anchored *seus*: conceded.* The ementa constitutes the objective reference set for "seus fundamentos determinantes." The purely designative check becomes: does the citing court's statement name a proposition the ementa characterizes as a fundamento determinante? This is an ementa-level text-to-text comparison, as the supportive states. The possessive *seus* is satisfied by reference to what the ementa says is determinante — not by independent ratio reconstruction from the underlying deliberation.

*Third case from round 15: conceded as handled.* Under the ementa-anchored designative reading, a citing court that nominates a proposition the ementa does not characterize as a fundamento determinante fails C1 — because the ementa's own characterization does not include that proposition in the reference set. The round 15 obiter-nomination case is handled: if the ementa does not identify proposition X as a fundamento determinante, citing court nomination of X fails the ementa-anchored designative check. This concession stands.

*Constitutive authority of the ementa: contested — a fourth case.* The three concessions above establish that the purely designative ementa-anchored account can handle the third case from round 15. But the account's ability to handle it depends on an assumption that has not been defended: that the ementa's characterization of fundamentos determinantes is *constitutive* — that is, that what the ementa says is a fundamento determinante IS a fundamento determinante for purposes of Art. 489, §1º, V, regardless of whether that characterization accurately reflects the underlying deliberation.

A fourth case contests this assumption directly. Suppose the deciding court's ementa mischaracterizes an obiter proposition as a fundamento determinante — the ementa names proposition Y as determinante, but Y was not actually load-bearing for the holding in the underlying deliberation; the majority's actual ratio rested on proposition Z, which the ementa does not list. A citing court that follows the ementa diligently — naming Y as the fundamento determinante, because the ementa says so — satisfies C1 under the purely designative ementa-anchored reading. But that citing court has not identified the cited precedent's actual fundamentos determinantes. It has identified what the ementa mischaracterized as determinante. This is the paradigm Art. 489, §1º, V failure: the court has invoked the precedent without correctly identifying its fundamentos determinantes — precisely because the ementa gave the wrong characterization and the citing court relied on it.

The ementa-anchored account handles this case only if the ementa's characterization is treated as constitutively determining what the fundamentos determinantes are — so that by definition there is no gap between "what the ementa says is determinante" and "what is actually determinante." But this move conflicts with the provision's text. Art. 489, §1º, V uses "seus fundamentos determinantes" — the cited precedent's fundamentos determinantes — not "os fundamentos determinantes que a ementa indica." The possessive refers to what is actually determinante in the cited precedent, not to what the ementa says is determinante. The ementa is a secretariat summary, prepared after the deliberation, that characterizes the decision's content. It can be — and in practice sometimes is — an imperfect or incomplete characterization. A constitutive account of the ementa's authority would make Art. 489, §1º, V's compliance requirement an ementa-following requirement rather than a ratio-identifying requirement, immunizing C1 failures that arise from erroneous ementa characterization rather than from the citing court's own failure to engage the precedent.

The annotation-task implication follows. If the ementa's authority is not constitutive but evidential — a presumption about the actual ratio, defeasible by careful reading of the underlying deliberation — then the step-2 annotation task under the evidential reading must include assessing whether the ementa accurately characterizes the underlying decision's fundamentos determinantes. That assessment re-introduces conceptual-coverage content at the ementa-accuracy level: the annotator must determine whether the specific proposition the ementa characterizes as determinante was actually determinative in the underlying deliberation, not merely whether the ementa makes that characterization. The annotation task crosses the specificity gap not at the citing-court-to-ementa level but at the ementa-to-underlying-deliberation level — a gap the constitutive account papers over but the evidential account cannot.

*Relationship to the IRR falsification condition.* The IRR discriminating test remains the empirical resolution mechanism. Under the constitutive ementa account, the fourth case does not arise: the ementa's characterization is correct by institutional definition, and arm-specific C1 IRR should be high (ementa-reading is tractable). Under the evidential ementa account, the fourth case introduces a class of disagreements among annotators who read the underlying deliberation and assess the ementa's accuracy differently — a class that produces lower IRR specifically in cases where the ementa's characterization is contested on doctrinal grounds. The arm-specific C1 IRR data should be reported separately for cases where the ementa's characterization of fundamentos determinantes is contested in the secondary literature or in subsequent decisions — to discriminate between the constitutive and evidential ementa-authority accounts.
...
On (15): the V/VI textual-economy argument is conceded — the adversarial's round 15 non-redundancy concession, inverted by the supportive, establishes that V's *identificar* is purely designative; the ementa-anchored *seus* account is conceded — the ementa constitutes the objective reference set for "seus fundamentos determinantes," and the designative check is ementa-level text-to-text comparison; the third case from round 15 (obiter-nomination) is conceded as handled by the ementa-anchored reading — a proposition the ementa does not characterize as fundamento determinante fails C1 under the designative ementa check; the constitutive authority of the ementa is contested through a fourth case — when the ementa mischaracterizes an obiter proposition as ratio, a citing court that follows the ementa satisfies C1 under the purely designative ementa-anchored reading but has not identified the actual fundamentos determinantes, which is the paradigm §1º, V failure; the fourth case contesting constitutive authority is grounded in the provision's text ("seus fundamentos determinantes" — what is actually determinante — not "o que a ementa indica como determinante") and in the institutional argument that treating ementa characterization as constitutive immunizes C1 failures arising from erroneous ementa characterization; if ementa authority is evidential rather than constitutive, the step-2 annotation task must include assessing whether the ementa accurately characterizes the underlying deliberation — re-introducing conceptual-coverage content at the ementa-accuracy level; and the IRR discriminating test extends to arm-specific C1 IRR for cases where the ementa's characterization of fundamentos determinantes is contested in secondary literature or subsequent decisions, to discriminate between constitutive and evidential ementa-authority accounts.
...
cross-cluster-convention and cross-elaboration extensions; round 15 accepts the C1/C4
structural distinction as formally valid while contesting the purely designative reading
of *identificar* — the possessive *seus* and the parallel *que justifiquem* in Art. 489,
§1º, VI are offered as statutory grounds for the conceptual-coverage reading; the third
case (obiter nominated as fundamento determinante) is identified as the paradigm C1
failure missed by the purely designative reading; round 16 concedes the V/VI textual-
economy argument (V's *identificar* is purely designative, the adversarial's own round 15
non-redundancy concession reversed as the supportive's premise), concedes the ementa-
anchored *seus* account (the ementa constitutes the objective reference set), and concedes
the third case as handled; the surviving C1 annotation-task challenge relocates to the
constitutive authority of the ementa's characterization: if the ementa is evidential rather
than constitutive, a fourth case (ementa mischaracterizes obiter as ratio) re-introduces
conceptual-coverage content at the ementa-accuracy level; the IRR discriminating test
extends to arm-specific C1 IRR for cases where the ementa's characterization is contested
in secondary literature or subsequent decisions.
...
the implicit-structure flagging rate; round 15 accepts the C1/C4 structural distinction as formally valid while contesting the purely designative reading of *identificar* — the conceptual-coverage reading is textually grounded in the possessive *seus* and the parallel *que justifiquem* formulation in Art. 489, §1º, VI — and the third case (obiter nominated as fundamento determinante) is identified as the paradigm C1 failure missed by the purely designative reading; round 16 concedes the V/VI textual-economy argument (V's *identificar* is purely designative), concedes the ementa-anchored *seus* account (the ementa constitutes the objective reference set), and concedes the third case as handled under the ementa-anchored reading — while contesting the constitutive authority of the ementa through a fourth case: when the ementa mischaracterizes an obiter proposition as ratio, a citing court that follows the ementa satisfies C1 under the purely designative ementa-anchored reading but has not identified the actual fundamentos determinantes; the provision's text ("seus fundamentos determinantes") refers to what is actually determinante in the cited precedent, not to what the ementa says is determinante; if ementa authority is evidential rather than constitutive, the step-2 annotation task must assess whether the ementa accurately characterizes the underlying deliberation — re-introducing conceptual-coverage content at the ementa-accuracy level; and the IRR discriminating test extends to arm-specific C1 IRR for cases where the ementa's characterization of fundamentos determinantes is contested.
...
7. **C1 annotation task tractability confirmed — designative reading accepted, ementa constitutive authority established.** Round 16 concedes the purely designative reading of *identificar* in Art. 489, §1º, V on V/VI textual-economy grounds: V's *identificar* is purely designative, and the ementa constitutes the objective reference set for "seus fundamentos determinantes." The C1 annotation-task challenge at the round 14–15 level — whether *identificar* requires conceptual-coverage judgment — is accepted as resolved in the supportive's favor. The surviving C1 attack relocated in round 16 is at the level of the ementa's authority: whether the ementa's characterization of fundamentos determinantes is constitutive or evidential. The attack at the C1 front falls in whole if primary Brazilian procedural authority — a superior court decision or authoritative doctrinal treatment — establishes that the ementa's characterization of the decision's fundamentos determinantes is constitutive for purposes of Art. 489, §1º, V compliance assessment: that is, that "seus fundamentos determinantes" in Art. 489, §1º, V refers to what the ementa characterizes as determinante rather than to what was actually determinante in the underlying deliberation. Under the constitutive ementa account, the step-2 annotation task is ementa-level text-to-text comparison — is the proposition the citing court names one that the ementa characterizes as a fundamento determinante? — a tractable designation check. The fourth case (ementa mischaracterizes obiter as ratio) does not arise under constitutive authority: the ementa's characterization is institutionally authoritative and no gap between ementa-characterization and actual-ratio is cognizable for C1 purposes. Absent primary authority establishing constitutive ementa status, both the constitutive and evidential accounts are available from the provision's text; the evidential account re-introduces conceptual-coverage content at the ementa-accuracy level; and the annotation task's difficulty profile depends on which account is operative — a question the IRR data for contested-ementa cases would illuminate empirically.
