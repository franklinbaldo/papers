...
7. **Ementa confirmed as constitutive authority for art. 489, §1º, V compliance assessment, without an available restricted evidential trigger.**
   ...
   *ratio* characterization for arts. 926–927 citation compliance purposes — distinguishes it
   ...
   theory of how they interact. Path (b) now additionally requires the supportive to show: why
   the ementa's ratio-constitutive function — a precedent-coherence function — specifically
   triggers art. 93, IX CF's reasoning-expression accountability mechanism rather than remaining
   within arts. 926–927's scope; why art. 926 caput does not independently ground obligation (a),
   making art. 93, IX CF structurally necessary; and how dual-provision grounding resolves rather
   than doubles the normative source. Under either path (a) or (b) fully met, the fourth case (ementa elevation error)
