"""Precompute frozen MiniLM/E5 semantic fields once for local MaleCNS runs."""
...
def main() -> None:
    ...
    parser.add_argument("--backend", choices=["openvino", "torch"], default="openvino")
    parser.add_argument("--device", default="GPU", help="OpenVINO device (GPU/CPU) or torch device")
