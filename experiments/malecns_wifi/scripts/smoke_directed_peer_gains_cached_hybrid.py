"""Run the local hybrid directed-peer smoke from a frozen semantic embedding cache.

Only the frozen encoder preparation is replaced.  All downstream scientific
logic comes from smoke_directed_peer_gains_local_hybrid unchanged.
"""
...
import smoke_directed_peer_gains_local_hybrid as hybrid
