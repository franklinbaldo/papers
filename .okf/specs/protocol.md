...
**`type` value:** `"Protocol"`
**Applies to:** `archive/adversarial-paper-development/protocol.md`. Currently the only file of this type.
...
reconstructed by reading dozens of session logs. `archive/adversarial-paper-development/protocol.md` exists
...
`archive/adversarial-paper-development/synthesis/blog/` entries, with no canonical document anywhere.
...
`archive/adversarial-paper-development/protocol.md`'s structure — role definitions, then one section per
...
absorption trigger is revised again), update `archive/adversarial-paper-development/protocol.md` in the same
