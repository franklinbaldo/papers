...
description: "Vendored copy of the OKF spec this repository adopts for document frontmatter and structure."
resource: "https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md"
tags: [okf, spec]
timestamp: 2026-07-09T00:00:00Z
---

> **Vendoring note.** This is a verbatim copy of OKF v0.1 as published at
> the `resource` URL above, fetched 2026-07-09. It is vendored so this
> repository's OKF adoption does not depend on that external repository
> staying reachable or unchanged. If OKF publishes a new minor/major
> version, update this file and `okf/index.md`'s stated `okf_version`
> together. See `okf/index.md` for how this repository applies the spec,
> and `okf/types/` for this repository's concrete document types.
